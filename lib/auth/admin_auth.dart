...
class AdminAuth {
  ...
  /// skipped on future launches (unless skipActivation is true — used
  /// by the personal login "Forgot Password" flow which just needs to
  /// verify credentials without re-writing the activation flag).

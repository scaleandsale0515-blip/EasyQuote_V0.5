...
class PdfTemplateBuilders {
  ...
  static Future<Uint8List> _buildLetterhead(CompanyProfile p, Client c,
    ...
    pw.Widget page(List<pw.Widget> content) => pw.Stack(children: [
      // Red left sidebar strip
      pw.Positioned(left: 0, top: 0, bottom: 0, width: sidebarWidth, child:
        pw.Container(color: t.accent)),
      pw.Padding(
        padding: const pw.EdgeInsets.only(left: sidebarWidth + 14),
        child: pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: content),
      ),
      // Sidebar content: company name vertical
      pw.Positioned(
        left: 0, top: 0, width: sidebarWidth,
        child: pw.SizedBox(
          height: 842,
          child: pw.Center(
